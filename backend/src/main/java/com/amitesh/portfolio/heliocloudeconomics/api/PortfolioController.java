package com.amitesh.portfolio.heliocloudeconomics.api;
...
public class PortfolioController {
    ...
    @GetMapping("/about")
    public Map<String, String> about() { return Map.of("product", "Helio Cloud Economics", "recordType", "Cost action"); }
